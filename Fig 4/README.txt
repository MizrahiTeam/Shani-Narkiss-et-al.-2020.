In order to plot PCA figures, chose one of the following options:

1- rmake sure that you have previously ran the codes sequentially, according to the following order, in order to save in earlier stage variables that will be used in later scripts:
...
and then run the PCA provided codes.
...
2- Alternatively, run the PCA codes directly directly, and use preliminarily acquired variables- all are located in the “General_Physiology\MATLAB Supp” folder
